...
cat master.log | ${DIAGRAM_SERVICES} MEMLOG_E_S1_RUN MEMLOG_E_S1_DONE 1 $1 $2 > service1.dat 
cat master.log | ${DIAGRAM_SERVICES} MEMLOG_E_S2_RUN MEMLOG_E_S2_DONE 2 $1 $2 > service2.dat 
cat master.log | ${DIAGRAM_SERVICES} MEMLOG_E_S3_RUN MEMLOG_E_S3_DONE 3 $1 $2 > service3.dat 

# jitters
echo "Creating S1 jitter data"
${TIME_DIFF} master.log MEMLOG_E_S1_DONE | awk '{print $1 " " $3}' | ${DIAGRAM_FILTER} $1 $2 > jitter_S1.dat

echo "Creating S2 jitter data"
${TIME_DIFF} master.log MEMLOG_E_S2_DONE | awk '{print $1 " " $3}' | ${DIAGRAM_FILTER} $1 $2 > jitter_S2.dat

echo "Creating S3 jitter data"
${TIME_DIFF} master.log MEMLOG_E_S3_DONE | awk '{print $1 " " $3}' | ${DIAGRAM_FILTER} $1 $2 > jitter_S3.dat
