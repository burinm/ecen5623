...
while [ 1 ]
    do
        ...
        DEPTH=$(sudo cat /dev/mqueue/w1q | awk  '{ newline=$1; split(newline,subfields,":"); print subfields[2] }')
        ...
        DEPTH=$(sudo cat /dev/mqueue/w2q | awk  '{ newline=$1; split(newline,subfields,":"); print subfields[2] }')
